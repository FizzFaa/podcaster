    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('blog-edit-post',['id'=>$blog->id]) }}"
                      ...
                      <div class="form-group row">
                          ...
                          <div class="col-md-6">
                              <input id="title" type="text"
                                     ...
                                     name="title" value="{{ $blog->title }}" required autocomplete="off"
                                     autofocus>
                      ...
                      <div class="form-group row">
                          ...
                          <div class="col-md-6">
                            <textarea name="desc" id="summary-ckeditor" cols="30" rows="10">{!! $blog->desc  !!}</textarea>
                        ...
                        <div class="col-md-6">
                            <select class="form-control @error('category') is-invalid @enderror role"
                                ...
                                @foreach($categories as $cat)
                                    <option
                                        value="{{ $cat->id }}" @if($blog->cat_id ==$cat->id ) selected @endif> {{ $cat->title }} </option>
                                @endforeach
                            </select>
