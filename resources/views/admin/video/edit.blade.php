    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('video-edit-post',['id'=>$video->id]) }}"
                      ...
                      <div class="form-group row">
                          ...
                          <div class="col-md-6">
                              <input id="title" type="text"
                                     ...
                                     name="title" value="{{ $video->title }}" required autocomplete="off"
                                     autofocus>
                      ...
                      <div class="form-group row">
                          ...
                          <div class="col-md-6">
                            <textarea name="desc" id="summary-ckeditor" cols="30" rows="10">{!! $video->desc !!}</textarea>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="video_link" type="text"
                                   ...
                                   name="video_link" value="{{ $video->video_link }}" required autocomplete="off"
                                   autofocus>
                        ...
                        <div class="col-md-6">
                            <select class="form-control @error('category') is-invalid @enderror role"
                                ...
                                @foreach($categories as $cat)
                                    <option
                                        value="{{ $cat->id }}" @if($video->cat_id ==$cat->id ) selected @endif> {{ $cat->title }} </option>
                                @endforeach
                            </select>
